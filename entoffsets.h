...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_body;
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_eye_angles;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR( m_body,       HASH( "DT_CSPlayer" ),             HASH( "m_body" ) );
        ...
        INIT_XOREDNETVAR( m_eye_angles,               HASH( "DT_CSPlayer" ),             HASH( "m_eye_angles" ) );
